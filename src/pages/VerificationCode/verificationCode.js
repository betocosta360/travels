            ...
            <View style={styles.overlayBackground}>
                ...
                <View style={[styles.boxForm, styles.shadowProp]}>
                    ...
                    <View style={styles.boxUser}>
                            <TextInput style={styles.formUser} placeholder='Digite o código de verificação...' />
                        ...
                        <View style={styles.footerText}>
                                <TouchableOpacity>
                                    <Text style={{ color: '#888', textAlign: 'center'}}>Reenviar(30)</Text>
                                </TouchableOpacity>
                        ...
                        <View style={styles.boxButtom}>
                            <View style={styles.buttonLogin}>
                                ...
                                <TouchableOpacity style={styles.button}>
                                    <Text style={styles.textButton}>Verficar</Text>
                                </TouchableOpacity>
